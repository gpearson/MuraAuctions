<cfcomponent displayName="Event Registration Email Routines">
	...
	<cffunction name="SendAccountActivationEmail" returntype="Any" Output="false">
		...
		<cfset AccountActiveLink = "http://" & #CGI.Server_Name# & "/index.cfm/grant-information/grant-information/?GrantApplicationaction=public:registeruser.activateaccount&" & #Variables.AccountVars#>

...
You have successfully registered for an account on the Auction Surplus Website. In order to make your account active, please click the link below. Upon clicking the link below, your account will become active and will be able to login with your email address and desired password.
...
<cfmailpart type="text/html">
	<html><body>
		<table border="0" align="center" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr><td Style="Font-Family: Arial; Font-Size: 12px; Font-Weight: Normal; Color: Black;">You have successfully registered for an account on the Auction Surplus Website. In order to make your account active, please click the link below. Upon clicking the link below, your account will become active and will be able to login with your email address and desired password.</td></tr>
			<tr><td Style="Font-Family: Arial; Font-Size: 12px; Font-Weight: Normal; Color: Black;">&nbsp;</td></tr>
			<tr><td Style="Font-Family: Arial; Font-Size: 12px; Font-Weight: Normal; Color: Black;">&nbsp;</td></tr>

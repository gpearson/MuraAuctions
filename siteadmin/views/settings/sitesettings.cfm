...
<cfoutput>
	<div class="panel panel-default">
		...
		<cfform action="" method="post" id="CreateNewUser" class="form-horizontal">
			...
			<cfinput type="hidden" name="PluginModuleID" value="#Session.SitePluginSettings.PluginModuleID#">
			<cfinput type="hidden" name="formSubmit" value="true">
			<div class="panel-body">
				<div class="form-group">
					<label for="SellerPercentageFee" class="control-label col-sm-3">Seller's Percentage Fee:&nbsp;</label>
					<div class="col-sm-8">
						<cfif LEN(Session.SitePluginSettings.GetPluginSettings.SellerPercentageFee)>
							<cfinput type="text" validate="numeric" class="form-control" id="SellerPercentageFee" name="SellerPercentageFee" value="#Session.SitePluginSettings.GetPluginSettings.SellerPercentageFee#" required="yes">
						<cfelse>
	...
	<cfdump var="#Session.SitePluginSettings#">
</cfoutput>
